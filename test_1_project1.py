...
class Test1(unittest.TestCase):
    def setUp(self):
        ...
        self.result51, self.result52  = app_with_most_successful_runs("test2.txt")
        self.result61, self.result62 = third_of_day_with_most_failures("test2.txt")
        self.result7= run_times_per_app("test2.txt")
        self.result8= busiest_hour_per_app("test2.txt")
        self.result9= calculate_failure_rates("test2.txt")
